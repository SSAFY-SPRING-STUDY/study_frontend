      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl bg-[var(--surface-container-lowest)] p-8 shadow-ambient">
          ...
          <a
            ...
            className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[var(--surface-container-low)] px-4 py-2.5 text-sm font-medium text-[var(--on-surface)]/70 hover:bg-[var(--surface-container-high)] transition-colors"
          >
