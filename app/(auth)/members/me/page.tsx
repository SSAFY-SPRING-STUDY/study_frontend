          ...
          <div className="ui-card-static p-6">
            <div className="flex items-start justify-between gap-4">
              ...
              {user.githubUsername ? (
                ...
                <button
                  type="button"
                  onClick={() => setIsConnectingGithub(true)}
                  disabled={isConnectingGithub}
                  className="ui-btn ui-btn-outline px-3 py-1.5 text-sm disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {isConnectingGithub ? (
                    <>
                      <span
                        className="h-3.5 w-3.5 animate-spin rounded-full border-2 border-[var(--on-surface)]/20 border-t-[var(--on-surface)]/70"
                        aria-hidden="true"
                      />
                      이동 중...
                    </>
